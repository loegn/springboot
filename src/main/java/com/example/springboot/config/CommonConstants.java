...
//    public static final String MAPPERSCAN = "com.example.springboot.dao";
     ...
     * 过滤器扫描根目录
     */
    public static final String FILTER_SCAN = "com.example.springboot.filter";
    /**
     * 监听器扫描根目录
     */
    public static final String LISTENER_SCAN = "com.example.springboot.listener";
    /**
     * 控制层扫描根目录
     */
    public static final String CONTROLLER_SCAN = "com.example.springboot.controller";
    /**
     * 尝试登录次数
     */
